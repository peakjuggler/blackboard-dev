@tool
extends Node2D
class_name CarouselManager

@export var spacing := 20.0

@export var wraparound_enabled := false
@export var wraparound_radius: float = 20.0
@export var wraparound_height: float = 50.0

@export_range(0.0, 1.0) var opacity_strength := 0.35
@export_range(0.0, 1.0) var scale_strength := 0.25
@export_range(0.01, 0.99, 0.01) var scale_min := 0.35
